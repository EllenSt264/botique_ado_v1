...
class Order(models.Model):
    ...
    # Use models.SET_NULL to keep an order history in the admin even if the
    # profile is deleted, which will also allow null or blank to be true
    # to allow users that don't have an account to make a purchase.
    # Add a related name of 'orders' so we can access the user's order by
    # calling 'user.userprofile.orders'.
